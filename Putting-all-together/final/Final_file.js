...
var UIController = (function() {
    ...
    var formatNumber = function(num, type) {
        ...
        // math.abs(absolute) it means abs is used to remove the sign of the number
        num = Math.abs(num);
        ...
        // putting - or + sugn using ternary operator
    ...
    return {
        ...
        changedType: function() {
            ...
            //adding red color to feilds when expenses is select
            nodeListForEach(fields, function(cur) {
                cur.classList.toggle('red-focus');
            });
             // adding red on button
