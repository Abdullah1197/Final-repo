...
// execute javascript code. There are many
// others engine.
...
// function.
// 3. Code Is scanned for variable declaration:
// for each variable, a property Is created In
// the variable object and set to undefined.
...
function calculateAge(year) {
    ...
    // this is function deleration and this
    // case work for both cases if we call a
    // function before or after deleare function.
...
var retirement = function(year) {
    ...
    // this is function expression and for this if
    // we call function above from function expression
    // so it will not work.
...
console.log(age);
var age = 23; // defined in gloabal executation
              // context

// if we use variable before the decleration
// than it will become undifined and this
// how hoisting work with variables.
...
console.log(age); // calling age which is
...
// the scope is created by if blocks for blocks
// and while blocks but not in javaScript.

// In javaScript only way to create a scope is
...
// function third() {
//     var d = 'John';
//     console.log(c); // third function can not access
//                     // the c because it is in the different scope.
//     console.log(a + d); // third function can only access
//                         // the a and d because it is in the same scope.
// }
...
// in regular function this keyword points at
// the global object.
// in method call that function is attched to
// an object, this variable point to the object
...
// so again even though it appears this variable
// refers to the object where it is defined but this
// variable technacilly only assigned value as soon
// as an object called method.
